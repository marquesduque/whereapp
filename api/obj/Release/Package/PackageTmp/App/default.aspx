...
<body style="background-color: var(--dark-color); background-image: url('/api/filiais?background_id=<%= api.Models.db.place.place_id %>'); background-size: cover; background-repeat: no-repeat">
    ...
    <div id="left-menu" class="panel panel-right panel-reveal imagem-background" style="background-color: var(--primary-color); color: var(--primary-font-color)">
        ...
        <!-- Menu items -->
        <div id="menu_servico" class="list-block fonte_branca" style="display: none;">

            <div href="#" onclick="creait.redirect('perfil')" style="padding: 20px; background-color: var(--secondary-color); color: var(--secondary-font-color);">
                <i class="f7-icons" style="margin-right: 0px; font-size: 40px; float: left; margin: 1px 10px 0px 0px;">person_fill</i>

                <div class="nomegarcom" style="font-size: 18px; font-weight: 700; text-transform: uppercase;">
                    NOME
                </div>
            ...
            <ul>
                <li style="text-align: center" id="atencao_servico">
                    <b>Atenção</b>
                    <div style="font-size: 12px">Para começar a realizar atendimentos configure sua agenda agora</div>
                    <div class="buton close-panel" onclick="creait.redirect('servico')" style="background-color: var(--secondary-color); color: var(--secondary-font-color); margin-top: 10px">CONFIGURAR</div>
                </li>
                <li style="text-align: center; display: none" id="atencao_ativacao">
                    <b>Atenção</b>
                    <div style="font-size: 12px">Estamos validando o seu cadastro, em breve entraremos em contato!</div>
                </li>
                <li class="close-panel no-animation fonte_branca agendar_horario" id="menu_agenda" onclick="creait.redirect('consulta')">
                    <span class="icon-alarm"></span>
                    AGENDA
                </li>
                <li class="close-panel no-animation fonte_branca agendar_horario" onclick="creait.redirect('servico')">
        ...
        <div id="menu_usuario" class="list-block list-menu fonte_branca" style="margin: 0px !important; display: none">
            ...
            <div href="#" onclick="creait.redirect('perfil')" style="padding: 20px; background-color: var(--secondary-color); color: var(--secondary-font-color); cursor: pointer">
            ...
            <ul>
                <li class="close-panel li_menu_pedido">
                    <div style="font-size: 25px; text-align: center; font-weight: 700;">
                        ULTIMO PEDIDO
                    </div>
                    <div style="background-color: rgba(0, 0, 0, 0.60); color: var(--primary-font-color); padding: 10px; text-align: center; border-radius: 2px;">
                        <div id="alerta_titulo" style="font-weight: 700;">Seu pedido está pronto!</div>
                        <div id="alerta_id" style="border-radius: 2px; line-height: 20px; width: 159px; background-color: var(--secondary-color); margin: 10px auto; color: var(--secondary-font-color); padding: 10px; font-weight: 700;">
                            12345678
                        </div>
                        <div id="alerta_descricao" style="font-size: 12px;">Dirija-se ao balção para retirada</div>
                    </div>
                </li>
                <li class="close-panel" id="menu_pedido" onclick="creait.redirect('pedido')">
        ...
        <div id="menu_caixa" class="list-block list-menu fonte_branca" style="margin: 0px !important; display: none">
            ...
            <ul>
                <li class="close-panel" onclick="controller.cliente.set(null); creait.redirect('cliente')">
                    <span class="icon-cart"></span>
                    Novo Pedido
                </li>
                <li id="logout" class="close-panel no-animation fonte_branca" onclick="localStorage.clear(); window.location = '/'">
        ...
        <!-- Menu items -->
        <div id="menu_consulta" class="list-block list-menu fonte_branca" style="margin: 0px !important; display: none">
            ...
            <ul>
                <li class="close-panel" onclick="creait.redirect('categoria')">
                    <span class="icon-search"></span>
                    Buscar
                </li>
                <li class="close-panel" id="menu_agenda_cliente" onclick="creait.redirect('consulta')">
                    <span class="icon-calendar"></span>
                    Agenda
                </li>
                <li class="close-panel" onclick="creait.redirect('formulario')">
        ...
        <div id="menu_comanda" class="list-block list-menu" style="display: none">

            <div class="content-block">
                <div class="item-title text-medium" style="text-align: center">
                    <div onclick="creait.redirect('perfil')">
                        <img src="icons/garcom.svg" style="border-radius: 100px; width: 90px; background-color: var(--primary-color); padding: 10px;" />
                        <div style="font-size: 10px">
                            NOME DO GARÇOM
                        <div class="nomegarcom" style="font-size: 18px; font-weight: 700">
                            NOME
                        </div>
                        </div>
                    </div>
            ...
            <ul>
                <li class="close-panel" onclick="creait.redirect('mesas')">
                    <span class="icon-spoon-knife"></span>
                    MESAS
                                
                </li>
                <li class="close-panel" onclick="myApp.prompt('Escreva uma mensagem', 'NOTIFICAR CAIXA', function (a) { debugger; creait.post('notificacao', { descricao: a , titulo: controller.login.get().nome }, function () { creait.loader(false); });})">
                    <span class="icon-bell"></span>
                    NOTIFICAR
                                
                </li>
                <li class="close-panel menu_continuar" style="display: none" onclick="controller.cliente.set(controller.carrinho.memory.cliente); controller.carrinho.set(controller.carrinho.memory.carrinho); controller.carrinho.memory = null; $('.menu_continuar').hide(); creait.redirect('categoria');">
                    <span class="icon-box-remove"></span>CONTINUAR
                        <div style="font-size: 10px; margin-left: 40px;">
                        </div>
                </li>
                <li id="logout" class="close-panel" onclick="localStorage.clear(); window.location = '/'">
                    <span class="icon-unlocked"></span>
                    SAIR
                </li>
            </ul>
        ...
        <div id="menu_garcom" class="list-block list-menu" style="display: none">

            <div class="content-block">
                <div class="item-title text-medium" style="text-align: center">
                    <div onclick="$('formlogingarcom').toggle(500);">
                        <img src="icons/garcom.svg" style="border-radius: 100px; width: 90px; background-color: var(--primary-color); padding: 10px;" />
                        <div style="font-size: 10px">
                            NOME DO GARÇOM
                        <div class="nomegarcom" style="font-size: 18px; font-weight: 700">
                    ...
                    <formlogingarcom style="display: none">
                        <div class="list-block margin-bottom-40">
                            <ul class="no-border" style="padding:0px">
                                <li>
                                    <div class="item-content">
                                        <div class="item-inner no-margin">
                                            <div class="item-input">
                                                <input class="input-index" id="garcon_email" style="text-align:center" type="number" name="email" placeholder="Código de acesso">
                                                <input class="input-index" id="garcon_password" type="hidden" name="password" class="text-thiny" placeholder="Senha">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="row btn-form-group margin-bottom-10 margin-top-40">
                            <div class="col-100">
                                <div id="btn_login_garcom" class="buton">Entrar</div>
                    ...
                    <div style="clear: both"></div>
                    <ul class="sair_mesa">
                        <li class="close-panel no-animation fonte_branca" onclick="localStorage.clear(); window.location = '/'">
                            <span class="icon-unlocked"></span>
                            SAIR
                        </li>
                    </ul>
    ...
    <script>
        ...
        function find_alert() {
            ...
            function bind() {
                if (controller.layout.get() != null && controller.layout.get().NotPremium) {
                    creait.redirect('premium');
                }
                $(".li_menu_pedido").hide();
                $("#menu_pedido").find('.alert_bol').remove();
                $(".f7-icons:not(.sem_alerta):contains('person_fill')").find('.alert_bol').remove();
                if (alerta.length > 0) {
                    $(".f7-icons:not(.sem_alerta):contains('person_fill')").append('<div class="alert_bol animated pulse">' + alerta.length + '</div>');



                    $("#menu_pedido .alert_bol").remove()
                    $("#menu_pedido").append('<div class="alert_bol animated pulse">' + alerta.length + '</div>');
                    $("#menu_agenda_cliente .alert_bol").remove()
                    $("#menu_agenda_cliente").append('<div class="alert_bol animated pulse">' + alerta.length + '</div>');
                    $("#menu_agenda .alert_bol").remove()
                    $("#menu_agenda").append('<div class="alert_bol animated pulse">' + alerta.length + '</div>');

                    $('#alerta_titulo').html(alerta[0].status);
                    $('#alerta_id').html('N° ' + alerta[0].external_id);
                    $('#alerta_descricao').html(alerta[0].status_descricao);

                    if (controller.layout.get().balcao == true && controller.layout.get().delivery == false) {
                        $(".li_menu_pedido").show();
                        if (alerta_atual.external_id != alerta[0].external_id && alerta[0].status.indexOf('FINALIZADO') != -1) {
                            myApp.alert(alerta[0].status_descricao, 'PEDIDO FINALIZADO', function () {
                                creait.redirect('acompanhamento', 'compra_id=' + alerta[0].compra_id);
                            });
                            alerta_atual = alerta[0];
                        }
                    }

                    $(".li_menu_pedido").click(function () {
                        creait.redirect('acompanhamento', 'compra_id=' + alerta[0].compra_id);
                    });
                }
                if (notificacao.length > 0) {
                    if (notificacao_atual.id != notificacao[0].id) {
                        if (notificacao[0].titulo == null) {
                            debugger;
                            creait.get('notificacao?notificacao_id=' + notificacao[0].id, {}, function (json) {
                                if (
                                    window.location.href.toLowerCase().indexOf('acompanhamento') == -1 ||
                                    window.location.href.toLowerCase().indexOf('consulta') == -1 ||
                                    window.location.href.toLowerCase().indexOf('servico') == -1) {
                                    myApp.mainView.refreshPage();
                                }
                            });
                        }
                        else {
                            notificacao_atual = notificacao[0];
                            notificacao = [];
                            myApp.confirm(notificacao_atual.descricao, notificacao_atual.titulo, function () {
                                creait.loader(false);
                                debugger;
                                creait.get('notificacao?notificacao_id=' + notificacao_atual.id, {}, function (json) {
                                    creait.loader(false);
                                    if (notificacao_atual.url != null) {
                                        creait.redirect(notificacao_atual.url.split('?')[0], notificacao_atual.url.split('?')[1]);
                                    }
                                });
                                creait.loader(false);
                            });
                            $('.modal-button.modal-button-bold').html('Ver')
                        }
                    }
                }
            }
            ...
            if (controller.login.get() != null) {
                $.ajax({
                    url: creait.url + "/api/pedido", method: 'GET', dataType: 'json', cache: false, data: { cliente_id: controller.login.get().id, tempo: -10 }, success: function (result) {
                ...
                $.ajax({
                    url: creait.url + "/api/notificacao?para=" + controller.login.get().id, method: 'GET', dataType: 'json', cache: false, success: function (n) {
        ...
        if (window.location.href.indexOf("#!") == -1 || window.location.href.split("#!")[1].length == 0) {
            ...
            onloadpage(function () {
                ...
                var data = controller.layout.get();
                debugger;
                if (controller.login.get() != null && controller.login.get().perfil_id == 3) {
                    debugger;

                    creait.redirect(biblioteca.get('home'));
                }
                else if (controller.login.get() != null && controller.login.get().perfil_id == 5) {
                    debugger;
                    creait.redirect('mesas');
                }
                else if (controller.login.get() != null && controller.login.get().perfil_id == 7) {
                    debugger;
                    creait.redirect('cliente');
                }
                else if (controller.login.get() != null && controller.login.get().perfil_id == 6) {
                    ...
                    if (data.filiais.length == 1) {
                        controller.filial.set(data.filiais[0]);
                        if (data.delivery && data.balcao) {
                            $('.loader_off').show();
                            creait.loader(false);
                        }
                        else {
                        ...
                        else if (controller.filial.get() == null || controller.filial.get().length == 0) {
