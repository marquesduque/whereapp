...
GO
/****** Object:  Table [dbo].[status_usuario]    Script Date: 26/09/2018 07:50:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[status_usuario](
	[id] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[name] [varchar](50) NULL,
 CONSTRAINT [PK_status_usuario] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[pessoa]  WITH CHECK ADD  CONSTRAINT [FK_user_status_usuario] FOREIGN KEY([status_usuario_id])
REFERENCES [dbo].[status_usuario] ([id])
GO
ALTER TABLE [dbo].[pessoa] CHECK CONSTRAINT [FK_user_status_usuario]
GO
ALTER TABLE [dbo].[pessoa]  WITH CHECK ADD  CONSTRAINT [FK_usuario_perfil] FOREIGN KEY([perfil_id])
REFERENCES [dbo].[perfil] ([id])
GO
ALTER TABLE [dbo].[pessoa] CHECK CONSTRAINT [FK_usuario_perfil]
GO
